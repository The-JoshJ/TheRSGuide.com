---
title: Combat Mode
description: Understanding combat modes in RuneScape - Full Manual, Revolution, and Classic
---
...
- **Classic**: The old auto-attack system (not recommended)

> Classic mode should be avoided as the modern game is balanced around using abilities.
...
Toggles whether your style's Basic Attack will auto-cast when no other ability is pressed. Most newer players will want this **enabled**.
