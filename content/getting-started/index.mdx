---
title: Keybinds
description: How to Set Up Perfect Keybinds for RuneScape
---
...
<InteractiveLegend
  ...
  items={[
    ...
    },
    {
      ...
      description: "Your enhanced abilities",
...
> **Note:** It's recommended that you release your primary key before your modifier key to prevent the primary ability from firing. e.g. CTRL + R -> release R -> Release CTRL
...
For additional keybind theory, check out this video from several years ago - while the video is older, all of the theory still stands today.
