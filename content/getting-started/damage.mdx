...
5. Utilize player accuracy buffs such as stat boosting potions, prayers, or special attacks.
...
Every player also has a base **Critical Strike Chance** of 10%. Unlike Critical Damage, this does not increase with level. The only way to modify your critical strike chance is through gear or ability modifiers.
  </SplitItem>
  <SplitItem width={50}>
